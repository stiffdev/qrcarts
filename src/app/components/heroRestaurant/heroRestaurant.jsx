...
const HeroRestaurant = ({appType, tagLine, description, mainActionText, extraActionText}) => {
  return (
    <div id="product">
      <div style={{textShadow:'0px 1px 1px gray'}} className="flex flex-col items-center justify-start font-sans min-h-96 bg-gray-50 lg:pt-10 lg:pb-20 bg-hero bg-cover">
        <div>
          <p className="p-3 pt-12 text-lg font-bold text-gray-200 ">{appType}</p>
        </div>
        <div>
